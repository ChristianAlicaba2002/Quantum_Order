                    ...
                    <div class="user-info-container">
                        ...
                        <div class="info-layout">
                                ...
                                <div class="profile-section">
                                    ...
                                    <div class="profile-names">
                                        <div class="info-group">
                                            ...
                                            <span class="info-message">Your complete name as it appears on official documents</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="details-side">
                                <div class="info-grid">
                                    ...
                                    <div class="info-group">
                                        ...
                                        <span class="info-message">Primary contact number for account verification and updates</span>
                                    </div>
                                    ...
                                    <div class="info-group">
                                        <label>Address</label>
                                        <p>{{$user->address}}</p>
                                        <span class="info-message">Your current residential address for delivery and contact</span>
                                    </div>
                            ...
                            <div class="full-width">
                                <i class="fas fa-edit edit-icon" onclick="EditInformation('{{$user->userId}}','{{$user->firstName}}','{{$user->lastName}}','{{$user->gender}}','{{$user->address}}','{{$user->PhoneNumber}}','{{$user->username}}','{{$user->image}}')"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="phoneNumber" maxlength="11" 
                                id="EditPhoneNumber" pattern="[0-9]{11}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address" list="addressList" 
                                id="EditAddress" placeholder="Choose Address" required>
